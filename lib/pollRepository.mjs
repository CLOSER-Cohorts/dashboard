...
const tokenObject = await getToken("user", "password", "host")
...
async function generateReports() {
  ...
  const orphanPhysicalInstances = await checkForReference(allPhysicalInstances['Results'], token, urlBase, '30ea0200-7121-4f01-8d21-a931a182b86d')
  ...
  const questionnairesNotWithinDataCollection = await checkForReference(allQuestionnaires['Results'], token, urlBase, 'c5084916-9936-47a9-a523-93be9fd816d8')
