...
const panelContentsForMismatchedTopics = (tableCell, itemCounts, hostname) => {
  ...
  test('loads and displays panel for questions and variables with mismatched topics', async () => {
    // ARRANGE
  ...
  test('loads and displays panel for questions mapped to multiple topics', async () => {
    // ARRANGE
    const {getByText} = render(<GenericDashboard value={1}
      data={dashboardData}
      tabNames={tabNames} 
      panelContents={panelContentsForItemsWithMultipleTopics}
      itemCounts={itemCountsPerAgency}
    />)
  ...
  test('loads and displays panel for variables mapped to multiple topics', async () => {
    // ARRANGE
    const {getByText} = render(<GenericDashboard value={2}
      data={dashboardData}
      tabNames={tabNames} 
      panelContents={panelContentsForItemsWithMultipleTopics}
      itemCounts={itemCountsPerAgency}
  ...
  test('loads and displays panel for questions mapped to no topics', async () => {
    // ARRANGE
    const {getByText} = render(<GenericDashboard value={3}
      data={dashboardData}
      tabNames={tabNames} 
      panelContents={panelContentsForItemsWithNoTopics}
      itemCounts={itemCountsPerAgency}
    />)
  ...
  test('loads and displays panel for variables mapped to no topics', async () => {
    // ARRANGE
    const {getByText} = render(<GenericDashboard value={4}
      data={dashboardData}
      tabNames={tabNames} 
      panelContents={panelContentsForItemsWithNoTopics}
      itemCounts={itemCountsPerAgency}
    ...
    expect(getByText('Question/variable topic mismatches')).toBeInTheDocument()
    expect(getByText('variablesMappedToNoGroups')).toBeInTheDocument()
